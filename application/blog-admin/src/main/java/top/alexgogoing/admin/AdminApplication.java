...
public class AdminApplication {
    ...
    private final static Logger logger = Logger.getLogger(AdminApplication.class);
    ...
    public static void main(String[] args) {
        Class<?>[] resources = new Class<?>[]{AdminApplication.class};
